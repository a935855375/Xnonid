...
object Handler {
  ...
  /**
    * A special type of [[server.mvc.Handler]] which allows custom logic to be inserted
    ...
    * To automatically execute all `Stage`s you can call [[server.mvc.Handler.applyStages]].
    */
