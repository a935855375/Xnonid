...
public final class Files {
    ...
    public interface TemporaryFileCreator {
        ...
        server.libs.Files.TemporaryFileCreator asScala();
    }
    ...
    public static class DelegateTemporaryFileCreator implements TemporaryFileCreator {
        private final server.libs.Files.TemporaryFileCreator temporaryFileCreator;

        @Inject
        public DelegateTemporaryFileCreator(
                server.libs.Files.TemporaryFileCreator temporaryFileCreator) {
        ...
        public boolean delete(TemporaryFile temporaryFile) {
            server.libs.Files.TemporaryFile scalaFile = asScala().create(temporaryFile.path());
            Try<Object> tryValue = asScala().delete(scalaFile);
            return (Boolean) tryValue.get();
        }

        @Override
        public server.libs.Files.TemporaryFileCreator asScala() {
    ...
    public static class DelegateTemporaryFile implements TemporaryFile {
        ...
        private final server.libs.Files.TemporaryFile temporaryFile;
        private final TemporaryFileCreator temporaryFileCreator;

        public DelegateTemporaryFile(server.libs.Files.TemporaryFile temporaryFile) {
        ...
        private DelegateTemporaryFile(
                server.libs.Files.TemporaryFile temporaryFile,
                TemporaryFileCreator temporaryFileCreator) {
            this.temporaryFile = temporaryFile;
            this.temporaryFileCreator = temporaryFileCreator;
        }
    ...
    /**
     * A temporary file creator that uses the Scala server.libs.Files.SingletonTemporaryFileCreator
     * class behind the scenes.
     */
    public static class SingletonTemporaryFileCreator implements TemporaryFileCreator {
        private server.libs.Files.SingletonTemporaryFileCreator$ instance =
                server.libs.Files.SingletonTemporaryFileCreator$.MODULE$;
