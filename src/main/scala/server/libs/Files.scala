...
object Files {
  ...
  trait TemporaryFileCreator {
    ...
    /**
      ...
      */
    def asJava: server.libs.j.Files.TemporaryFileCreator = new server.libs.j.Files.DelegateTemporaryFileCreator(this)
  }
  ...
  class DefaultTemporaryFileCreator @Inject()(
    ...
    private val logger = server.Logger(this.getClass)
  ...
  class DefaultTemporaryFileReaper @Inject()(actorSystem: ActorSystem, config: TemporaryFileReaperConfiguration)
    ...
    private[server] def disable(): Unit = {
