...
/**
  * Brings convenient implicit conversions from [[server.mvc.RequestHeader]] to [[Messages]].
  *
  * Example:
  * {{{
...
trait I18nSupport extends I18NSupportLowPriorityImplicits {
  ...
  /**
    ...
    * @return The preferred [[Messages]] according to the given [[server.mvc.RequestHeader]]
    */
